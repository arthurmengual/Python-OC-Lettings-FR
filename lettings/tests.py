...
def lettings_fixture():
    address = Address.objects.create(number='0', street='street',
                                     city='city', state='state', zip_code='98', country_iso_code='7')
...
class TestLettings:
    ...
    def test_letting(self, client, lettings_fixture):
        '''This test ...'''
        response = client.get(reverse('lettings:letting', kwargs={
                              'letting_id': lettings_fixture.id}))
